...
<head>
    ...
    <title>{{ config('app.name', 'CheckInCalendar') }}</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" aria-label="Main Menu">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'CheckInCalendar') }}
                </a>
